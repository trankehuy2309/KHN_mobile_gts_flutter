...
class ReportPauseStop extends StatelessWidget {
  const ReportPauseStop({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    List<ReportPauseStopModel> data =
        Get.find<DashboardReportController>().reportPauseStop;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('Báo cáo dừng đỗ'),
      ),
      body: data.isEmpty
          ? DataNullable()
          : ListView(
                                ...
                                .map(
                                  (item) => DataRow(
                                    cells: [
                                      ...
                                      DataCell(Text(item.coordinates)),
                                      DataCell(SizedBox(
                                        width: 250,
                                        child: Text(
                                          item.address,
